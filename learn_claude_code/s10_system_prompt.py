...
class SystemPromptBuilder:
    ...
    def _build_core(self) -> str:
        print(f"[Building core instructions for {self.workdir}]")
        return (
    ...
    def _build_tool_listing(self) -> str:
        ...
        print(f"[Built tool listing with {len(self.tools)} tools]")
        return "\n".join(lines)
    ...
    def _build_skill_listing(self) -> str:
        ...
        if not skills:
            return ""
        print(f"[Built skill listing with {len(skills)} skills]")
    ...
    def _build_memory_section(self) -> str:
        ...
        print(f"[Built memory section with {len(memories)} memories]")
        if not memories:
            return ""
    ...
    def _build_claude_md(self) -> str:
        ...
        print(f"[Built CLAUDE.md section with {len(sources)} sources]")
        return "\n\n".join(parts)
    ...
    def _build_dynamic_context(self) -> str:
        ...
        print(f"[Built dynamic context with {len(lines)} lines]")
